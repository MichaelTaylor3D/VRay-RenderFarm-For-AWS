...
const scaleLarger = async (instanceId, currentSize) => {
  const currentInstanceTypeIndex = instanceTypes.findIndex(type => type === currentInstanceType);
  const nextTypeIndex = currentInstanceTypeIndex == 0 ? currentInstanceTypeIndex : currentInstanceTypeIndex - 1;
